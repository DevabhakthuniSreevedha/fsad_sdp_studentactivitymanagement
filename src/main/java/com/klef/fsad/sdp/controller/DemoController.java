...
public class DemoController 
{
    ...
    public String index()
    {
        return "DTO Demo Controller";
    }

    @GetMapping("/viewallfacultydto")
    public ResponseEntity<?> viewAllFacultyDTO()
    {
        try
        {
        ...
        {
            return ResponseEntity.status(500).body("Error Fetching Faculty DTO Data");
        }
    }
    ...
    public ResponseEntity<?> viewAllStudentsDTO()
    {
        ...
        {
            return ResponseEntity.status(500).body("Error Fetching Student DTO Data");
        }
    }
